...
summary: 'BlueXPを使用すると"FSX for ONTAP の作業環境を管理できますスループットとストレージ容量およびIOPSを変更し、作業環境を削除することができます。' 
---
...
[role="lead"]
BlueXPを使用すると'FSX for ONTAP の作業環境を管理できますスループットとストレージ容量およびIOPSを変更し、作業環境を削除することができます。
